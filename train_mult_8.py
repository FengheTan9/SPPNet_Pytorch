...
if __name__ == '__main__':
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if epoch % 2 == 0:
            ...
            print('224-Epoch: {} \t loss: {} \t avg:{} \t time:{}'.format(epoch+1,loss_fn.val,loss_fn.avg,time.time()-time_0), flush=True)
            ...
            for imgs, classes in dataloader_180:
                ...
                optimizer.step()
                total_steps += 1
            print('180-Epoch: {} \t loss: {} \t avg:{} \t time:{}'.format(epoch + 1, loss_fn_180.val, loss_fn_180.avg, time.time()-time_1), flush=True)
        lr_scheduler.step()
